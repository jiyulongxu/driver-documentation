...
[[driver-blocking-async]]
== Appropriate header

Blablabla about blocking and async.

The examples in this chapter will ... For examples on async programming see <<driver-asynchronous-programming>>.
...
[[driver-asynchronous-programming]]
== Asynchronous programming

NOTE: The async API is available with the .NET and the Java drivers.
